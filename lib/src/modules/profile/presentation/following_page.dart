...
class _FollowingPageState extends State<FollowingPage> {
  ...
  void initState() {
    ...
    _future = _api.getFollowing(widget.userId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Following of ${widget.username}'),
      ...
      body: FutureBuilder<List<ProfileModel>>(
        ...
        builder: (context, snap) {
          ...
          if (users.isEmpty) {
            return const Center(child: Text('Không theo dõi ai.'));
          }
